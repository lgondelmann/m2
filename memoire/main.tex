...
Therefore we begin a more formal description of inlining by imposing some restrictions on typing system of ML that, without reducing drastically its expressiveness, still correspond to real-world examples, and at the same time allow to define inlining and to prove its correctness. 
