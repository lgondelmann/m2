...
\begin{definition}[(Inlining local bindings, $\hookdownarrow$)]
   Let $t$ be a term of the source language $T$ such that $t$ contains at least one local binding of some second-order variable $F$ (thus, introduced by $\tmlet{F}{t_0}{t_1}$ construction).
...
{\infrule[$I_1$-#1]
	...
	\begin{adjustwidth}{6em}{-14em}
		\begin{multicols}{2}
		\infrule[Let$_0$]{}{\boldsymbol{\tmlet{F}{s_1}{s_2} \hookdownarrow 				
			\tmsbst{s_2}{F}{s_1}}}
		\end{multicols}
	\end{adjustwidth}
