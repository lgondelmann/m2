...
\end{corr} 
	That is, our first goal to prove inlining terminating and always resulting in a first-order program is achieved. 
...
\subsection{Correctness Proof for Inlining}
	...
	Our final goal is to prove that inlining preserves the \textit{meaning} of the source term. 
