...
%\noindent 
%$\e[(\lambda x^{\mathfrak{B_{1}}}_{\tau_{1}}.\texttt{t})v] 
%  = \e(\lambda x^{\mathfrak{B_{1}}}_{\tau_{1}}.\texttt{t}) ~ \e(v) 
% \stackrel{\epsilon}{\rightarrow} \sbst{\e(\texttt{t})}{x^{\mathfrak{B_{1}}}_{\tau_{1}}}{\e(v)}$ \\
% 
\noindent 
\hspace*{1cm}{

$
\e[(\lambda x^{\bot}_{\tau_{1}}.\texttt{t})v]  \\
  = \e(\lambda x^{\bot}_{\tau_{1}}.\texttt{t}) ~ \e(\texttt{v})  \\
  = \lambda x_{\texttt{unit}}. \e(\texttt{t}))\e(\texttt{()})
 \stackrel{\epsilon}{\rightarrow} \sbst{\e(\texttt{t})}{x^{\bot}_{\texttt{unit}}}{()}
$}
