...
\begin{spacing}{1.5}
\begin{multicols}{2}
\infax[E-AppFun] {\stepone{(\lambda x^{b}_{\tau}.t)v}{\sbst{t}{x^{b}_{\tau}}{v}}} 

\infrule[E-AppRec]{{\texttt{t}_{2}} \rightarrow {\texttt{t}'_{2}}}{{\texttt{v}_{1} \texttt{t}_{2} } \rightarrow {\texttt{v}_{1} \texttt{t}'_{2}}} 

\infax[E-DeGhost]	 	{\stepone{\texttt{ghost t}}{\texttt{t}}} 


\infrule[E-AppLeft]{{\texttt{t}_{1}} \rightarrow {\texttt{t}'_{1}}}{{\texttt{t}_{1} \texttt{t}_{2} } \rightarrow {\texttt{t}'_{1} \texttt{t}_{2}}}
  
\infrule[E-AppRight]{{\texttt{t}_{2}} \rightarrow {\texttt{t}'_{2}}}{{\texttt{v}_{1} \texttt{t}_{2} } \rightarrow {\texttt{v}_{1} \texttt{t}'_{2}}}  
