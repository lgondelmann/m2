...
\begin{displaymath}
\begin{array}{@{\hspace*{-1em}}llllllll}
...
\begin{itemize}
\item[{\red 1.}] identify the fragment of ML where inlining can be done 
\item[{\red 2.}] define inlining procedure \pause
\item[{\red 3.}] prove that inlining 
\begin{itemize}	
...
%\end{adjustwidth}	
		...
		\infrule[] 
			{\vspace*{0.5em}\hspace*{-2.1em}\Gamma \vdash t_1 : \tau^i, \Rouge{\theta_1}, \Rouge{\rho_1} 
			\quad \Gamma, x:\tau^i  \vdash t_2 : \tau^j, \Rouge{\theta_2}, \Rouge{\rho_2} 
			\quad 
